...
<ol class="breadcrumb">
				...
				<div class="agile-tables">
					...
					<?php
						...
						$query="SELECT * FROM login_table WHERE role=3 AND status=1 ORDER BY l_id DESC";
						$seq=0;
			...
			<tbody>
				<tr>
					...
					<td><img height="100" width="135" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($val['u_profile']); ?>" /></td>
				...
				<?php
					...
					if(isset($_GET['del']))
					{
						$sql = "DELETE FROM login_table WHERE l_id=".$_GET['del']. "";
						$result1 = mysqli_query($con,$sql);
						if($result1)
						{
							$sql1 = "DELETE FROM user_detail WHERE l_id=".$_GET['del']. "";
