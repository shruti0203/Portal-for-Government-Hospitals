...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Hospital <i class="fa fa-angle-right"></i>Manage</li>
            </ol>
					...
					<div class="w3l-table-info">
					  ...
					  <div class="table-responsive">
						...
						<tr>
							...
							<td><a href="Edithospital.php?id=<?php echo $value['h_id'];?>" >EDIT</a></td>
							<td><a href="?del=<?php echo $value['h_id'];?>" onclick="return confirm('Are you sure you want to delete ?')">DELETE</a></td>
						</tr>
						<?php
						}
							if(isset($_GET['del']))
							{
								$query1 = "DELETE FROM hospital_details_table WHERE h_id = ".$_GET['del']. "";
