					...
					<div class="w3l-table-info">
					  ...
					  <div class="table-responsive">
						...
						<?php
							...
							$query = "SELECT l.* , a.* FROM login_table l,admin_details a WHERE l.l_id=a.l_id";
						...
						<tbody>
							...
							<td><img height="100" width="135" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($value['a_profile']); ?>" /></td>
							<td><?php echo $value['email_id']; ?></td>
							<td><?php echo $value['phone_no']; ?></td>
							<td><?php echo $value['password']; ?></td>
							<td><?php echo $value['gender']; ?></td>
							<td><?php echo $value['dob']; ?></td>
							<td><a href="Edituser.php?id=<?php echo $value['l_id'];?>" >EDIT</a></td>
						...
						<?php
							...
							if(isset($_GET['del']))
							{
								...
								if(!$result1)
								{
									$query2 = "DELETE FROM admin_details WHERE l_id = ".$_GET['del']. "";
