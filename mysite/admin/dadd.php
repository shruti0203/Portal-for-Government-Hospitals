...
<div class="left-content">
	   <div class="mother-grid-inner">
			...
			<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Doctors <i class="fa fa-angle-right"></i>Add</li>
            </ol>
<div class="agile3-grids">	
				...
				<div class="panel1 variations-panel">
					<h3 id="forms-horizontal">Add Doctors</h3>
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" placeholder="Enter Name" name="dname" required>
									</div>
								</div>
								...
								<div class="form-group mb-n">
									...
									<div class="col-sm-8">
										<input type="email" class="form-control1 input-lg" id="largeinput" placeholder="Enter Email Id" name="demail" required>
									</div>
								</div>
								...
								<div class="form-group mb-n">
									...
									<div class="col-sm-8">
										<input type="password" class="form-control1 input-lg" id="largeinput" placeholder="Enter Password" name="dpass" required>
									</div>
								</div>
								...
								<div class="form-group mb-n">
									...
									<div class="col-sm-8">
										<input type="password" class="form-control1 input-lg" id="largeinput" placeholder="Retype Password" name="drepass" required>
									</div>
								</div>
								...
								<div class="form-group mb-n">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1 input-lg" id="largeinput" placeholder="Enter Phone No" name="dno" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="number" name="age" min="25" max="60" class="form-control1" id="inputPassword" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1 input-sm" id="smallinput" placeholder="Specialization" name="special" required>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">Department</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="mediuminput" placeholder="Department" name="dept" required>
									</div>
								</div>
								<div class="form-group mb-n">
									<label  class="col-sm-2 control-label label-input-lg">Experience</label>
									<div class="col-sm-8">
										<input type="number" class="form-control1 input-lg" id="largeinput" placeholder="Experience" name="exp" required>
									</div>
								</div>
							...
							if(in_array($fileType,$allowTypes))
							{
								...
								else
								{
									...
									else
									{
										...
										$query = "INSERT INTO login_table(email_id,phone_no,password,role,status) VALUES('$email',$phoneno,'$pass',2,1)";
										$res = mysqli_query($con,$query);
										if($res)
										{
											$id = mysqli_insert_id($con);
											$query1 = "INSERT INTO doctors_detail_table(l_id,h_id,d_picture,d_name,dob,gender,age,specialization,department,experience) VALUES($id,1,'$imgContent','$name','$dob','$gender',$age,'$special','$dept','$exp')";
