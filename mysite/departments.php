...
<div class="banner_inner_content_agile_w3l">
	...
	<form method="POST">
		<select name="city" id="mySelect" >
			...
			<option value="Ahmedabad"  class="options">Ahmedabad</option>
			<option  value="Gandhinagar"  class="options" >Gandhinagar</option>
			<option value="Rajkot"  class="options">Rajkot</option>
			<option value="Surat"  class="options">Surat</option>
			<option value="Navsari"  class="options">Navsari</option>
			<option value="Vadodra"  class="options">Vadodra</option>
		</select>
		<input type="submit" value ="Search" id="submitbtn" name="search">
	...
	<div class="container">
		<h3 class="heading-agileinfo">Government Hospitals<span>We offer extensive medical procedures to outbound and inbound patients.</span></h3>
			...
			<?php	
				...
				{
					$city=$_POST['city'];
					$query = "SELECT * FROM hospital_details_table WHERE h_city='$city'";
